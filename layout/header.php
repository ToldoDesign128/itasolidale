...
<body <?php body_class('font-body'); ?>>
  ...
  <header class="flex justify-between items-center px-6 py-11">
    ...
    <a class="hover:text-red-700 focus:text-red-700" href="<?php echo get_home_url(); ?>">
      <img class="w-full max-w-48" src="<?php echo get_template_directory_uri(); ?>/images/ITASolidale-ETS-payoff.png"
        alt="logo-itas">
    </a>
    ...
    <!--div class="flex flex-nowrap justify-between items-center p-4 font-body">

      <a class="hover:text-red-700" href="chiSiamo.php">CHI SIAMO</a>
      <a class="hover:text-red-700" href="cosaFacciamo.php">COSA FACCIAMO</a>
      <a class="hover:text-red-700" href="page-donazioni.php">DONA</a>
    ...
    <form action="/" method="get">
      ...
      <div class="flex border-2 border-black m-4 bg-transparent rounded-2 rounded-md py-2 px-2 ">
        <input class="block placeholder-black focus:outline-none" type="search" name="s" id="serch"
