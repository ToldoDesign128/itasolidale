    ...
    <div class="my-2 mx-auto w-full">
        <div class="flex flex-row h-[38rem]">
            <div data-box class="flex-none w-1/12 relative overflow-hidden bg-zinc-300">
                ...
                <div data-box-toggler
                    class="flex items-center align-center whitespace-nowrap absolute h-full left-0 right-0 -rotate-90 origin-center mt-32 font-normal text-[22.50px]">
                ...
                <div role="button" class="top-0 bottom-0 left-0 right-0 absolute">
                    <div data-box-content class="text-left m-auto w-2/3 mt-40 sr-only opacity-0">
                        <h4 class="my-4 font-medium text-[54.93px] pl-24">Comitato per la Solidarietà dei Dipendenti
                            ITAS</h4>
            ...
            <div data-box class="flex-none w-1/12 relative overflow-hidden bg-zinc-500 text-white">
                ...
                <div role="button" class="top-0 bottom-0 left-0 right-0 absolute">
                    <div data-box-content class="text-left m-auto w-2/3 mt-40 sr-only opacity-0">
                        ...
                        <button
                            class="w-[129px] h-[49px] px-6 py-3 bg-white rounded-lg justify-center items-center gap-3 inline-flex">
                            <div class="text-center text-zinc-500 text-lg font-medium">Copia</div>
            ...
            <div data-box class="flex-none w-10/12 relative overflow-hidden bg-zinc-600 text-white">
                ...
                <div data-box-toggler
                    class="flex items-center align-center whitespace-nowrap absolute h-full left-0 right-0 -rotate-90 origin-center mt-32 w-[10%] font-normal text-[22.50px]">
