...
<main>
  ...
  <div class="p-20">
    ...
    <a class="flex mt-10 items-center align-middle " href="/">
      <div class="text-red-500 text-center align-middle inline-block text-2xl font-medium font-['Halyard Display']
        rounded-md
        p-4" style="color:#cb4c44">
        Torna alla HOME
      </div>
