    ...
    <div class="px-40">
        ...
        <div class="relative inline-block text-left flex items-start flex-row gap-x-5 m-6 ">
            ...
            for ($i = $lastYear; $i >= $firstYear; $i--) {
                ?>
                <a href="?pyear=<?= $i ?>&pcat=<?= $cat ?>"
                    class="<?php echo $i === $year ? "bg-red-500 text-white" : "bg-white" ?> font-extralight text-sm hover:bg-red-500 hover:text-white px-6 py-3 rounded-lg border border-stone-950 justify-start items-center inline-flex">
                    <?= $i ?>
                </a>
                <?php
